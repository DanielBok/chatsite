...
import ImgError404 from "./static/error-404.webp";
import ImgNeedSupport from "./static/need-support.png";
import ImgPageNotFound from "./static/page-not-found.webp";
import ImgWentWrong from "./static/something-went-wrong.png";
...
export default function ErrorBoundary() {
  ...
  function getImage(errorStatus: number) {
    ...
    function getImages() {
      switch (errorStatus) {
        case 404:
          return [ImgPageNotFound, ImgError404];
        default:
          return [ImgWentWrong, ImgNeedSupport];
      }
    }
  }
}